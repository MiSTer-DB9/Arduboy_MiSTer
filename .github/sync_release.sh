...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arduboy_MiSTer.git"
CORE_NAME=(Arduboy)
...
UPSTREAM_CORE_NAME=(Arduboy)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Arduboy.qpf)
COMPILATION_OUTPUT=(output_files/Arduboy.rbf)
